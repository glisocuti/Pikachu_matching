...
void Menu::exitScreen()
{
	...
	Controller::clearConsole();
	Controller::setConsoleColor(BRIGHT_WHITE, BLACK);
	Menu::printRectangle(58, 13, 35, 8);
	Menu::printRectangle(61, 18, 7, 2);
	Menu::printRectangle(84, 18, 6, 2);
	Controller::setConsoleColor(BRIGHT_WHITE, RED);
	Controller::gotoXY(0, 0);
	printLogo();
	...
	string str[2] = { "Yes", "No" };
	int left[] = { 59,64,71,82,87,93 }, word[] = { 32,32,175,174 }, color[] = { BLACK, RED }, top = 19;
	bool choice = 0;
	bool loop = 1;
	auto print1 = [&]()
	{
